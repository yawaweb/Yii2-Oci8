 ...
 *
 * @property-read false|float $cacheTime
 * @property-read mixed $isCached
 * @property-read array $allCachedTables
 * @property-read array $cacheCreationTimeKey
 * @property-read array $userSchemaCacheKey
 * @property string $lastInsertID The row ID of the last row inserted, or the last value retrieved from the
 * sequence object. This property is read-only.
 *
 */
class CachedSchema extends Schema
{
    /**
